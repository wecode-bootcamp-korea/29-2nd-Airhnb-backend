...
class KakaoSignInTest(TestCase):
    ...
    # @patch("users.utils.requests.get")
    ...
    def test_new_user_signin_success(self, mocked_token_requests, mocked_info_requests):
        ...
        mocked_token_requests.return_value = MockedTokenResponse()
        mocked_info_requests.return_value = MockedResponse()

        # mocked_token_requests.post = MagicMock(return_value = MockedTokenResponse())
        # mocked_info_requests.get  = MagicMock(return_value = MockedResponse())
        # mocked_info_requests.post = MockedResponse()
    ...
    #     response = client.get("/users/kakao/signin?code=testcode")
    #     # print(response)
    #     self.assertEqual(mocked_requests, 1)
    #     self.assertEqual(response.status_code, 200)